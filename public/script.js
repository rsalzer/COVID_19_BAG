...
function processActualData(mode, chosenDay) {
  ...
  for(var i=0; i<cantons.length; i++) {
    ...
    tr.innerHTML = `
      ...
      <td>${filteredForCanton.Total_Covid19Patients}</td>
      <td>${filteredForCanton.TotalPercent_Covid19Patients}</td>
      <td>${filteredForCanton.Total_AllPatients}</td>
      <td>${filteredForCanton.Total_Capacity}</td>
      <td>${filteredForCanton.TotalPercent_AllPatients}</td>
      <td>${filteredForCanton.ICU_Covid19Patients}</td>
      <td>${filteredForCanton.ICUPercent_Covid19Patients}</td>
      <td>${filteredForCanton.ICU_AllPatients}</td>
      <td>${filteredForCanton.ICU_Capacity}</td>
      <td>${filteredForCanton.ICUPercent_AllPatients}</td>
    `;
